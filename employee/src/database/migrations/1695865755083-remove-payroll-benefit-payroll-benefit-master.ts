...
export class RemovePayrollBenefitPayrollBenefitMaster1695865755083
  implements MigrationInterface
{
  async up(queryRunner: QueryRunner): Promise<void> {
    //Remove payroll benefit from materialized view
    ...
    //Drop table payroll benefit master and payroll benefit
    await queryRunner.query(`
        DROP TABLE payroll_benefit_master;
